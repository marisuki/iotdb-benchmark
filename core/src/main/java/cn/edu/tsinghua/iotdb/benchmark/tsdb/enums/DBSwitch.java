...
public enum DBSwitch {
  ...
  DB_IOT_UDF_JDBC(DBType.IoTDB, DBVersion.IOTDB_UDF, DBInsertMode.INSERT_USE_JDBC),
  DB_IOT_UDF_SESSION_BY_TABLET(
          DBType.IoTDB, DBVersion.IOTDB_UDF, DBInsertMode.INSERT_USE_SESSION_TABLET),
  DB_IOT_UDF_SESSION_BY_RECORD(
          DBType.IoTDB, DBVersion.IOTDB_UDF, DBInsertMode.INSERT_USE_SESSION_RECORD),
  DB_IOT_UDF_SESSION_BY_RECORDS(
          DBType.IoTDB, DBVersion.IOTDB_UDF, DBInsertMode.INSERT_USE_SESSION_RECORDS),
